...
/**
 * Project name:    impala-client
 * Author:          lzy12173
 * Created date:    2015/12/07 9:26
 * Desc:
 * To do:
 */
public class ImpalaConnectTest {

    private static String host="hadoop-slave2";
    private static int port=21050;
    private static String stmt="select *  from myshema.people limit 1";
